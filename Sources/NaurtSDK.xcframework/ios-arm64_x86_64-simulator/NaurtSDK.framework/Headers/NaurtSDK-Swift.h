...
- (void)onAppClose;
- (BOOL)pointOfInterestWithMetadata:(NSDictionary * _Nonnull)metadata error:(NSError * _Nullable * _Nullable)error;
...
@protocol NaurtDelegate
- (void)didUpdateLocationWithNaurtPoint:(NaurtLocation * _Nonnull)naurtPoint;
- (void)onAppClose;
@optional
- (void)didChangeValidatedWithIsValidated:(BOOL)isValidated;
- (void)didInteractWithGeofenceWithEvents:(NSDictionary * _Nonnull)events;
- (void)anomalyAlertWithAlert:(AnomalyAlert * _Nonnull)alert;
- (void)errorStreamWithErrorInformation:(NSString * _Nonnull)errorInformation;
@end
